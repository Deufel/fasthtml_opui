# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_styles.buttons.ipynb.

# %% auto 0
__all__ = ['setup_button_styles']

# %% ../../nbs/02_styles.buttons.ipynb 2
def setup_button_styles():
    """Setup button component styles"""
    return Style("""
